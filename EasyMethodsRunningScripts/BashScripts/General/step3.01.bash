...
#This step Calculates the MAFFT GINSI alignment
...
outputdir=../../ProcessedData/GINSIAlignments/"$NucleicOrAmino"Acids/$DatasetName
...
echo Doing Mafft GINSI Alignment on Raw Fasta Files ...
cd $inputdir
echo $inputdir
for file in *; do
	if [[ ! -s $outputdir/$file ]]; then
		mafft --maxiterate 1000 --globalpair --thread 4 $file > $outputdir/$file
	fi
done
