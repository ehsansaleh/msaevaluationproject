...
#This step Calculates the MAFFT EINSI alignment
...
outputdir=../../ProcessedData/EINSIAlignments/"$NucleicOrAmino"Acids/$DatasetName
...
echo Doing Mafft EINSI Alignment on Raw Fasta Files ...
cd $inputdir
echo $inputdir
for file in *; do
	if [[ ! -s $outputdir/$file ]]; then
		mafft --maxiterate 1000 --genafpair --thread 4 $file > $outputdir/$file
	fi
done
